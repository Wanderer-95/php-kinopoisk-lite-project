...
<main>
    <div class="container">
        ...
        <table class="table table-dark table-hover mb-xxl-5">
            <thead>
            <tr>
        ...
        <?php if ($session->has('category-error-update')) { ?>
            <div id="category" class="alert alert-danger" role="alert">
                <?php echo $session->getFlash('category-error-update') ?>
            </div>
        <?php } ?>
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h4>Жанры</h4>
